...
<body>
	<nav class="navbar navbar-inverse">
  		<div class="container-fluid">
    		...
    		<ul class="nav navbar-nav navbar-right">
    		  ...
    		  <li><a href="#">Restaurants A-Z</a></li>
    ...
    <sql:query var="listUsers"   dataSource="${myDS}">
  	...
  	<h4 class="lab" style="font-weight: 900;">All Restaurants A - Z</h4>
  	<br><br>
		...
		<c:forEach var="restaurants" items="${listUsers.rows}">
			...
			<div class="box">
				...
				<div class="inner">
					...
					Rating - 
					<span class="fa fa-star checked"></span><c:out value="${restaurants.rating}" />
